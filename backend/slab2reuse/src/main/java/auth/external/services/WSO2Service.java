package auth.external.services;

import auth.external.dtos.CredentialResponseDto;
import dk.bm.fido.auth.external.enums.W2isServerEPType;
import auth.external.dtos.CredentialOptionsRequestDto;
import auth.external.dtos.DeviceDto;
